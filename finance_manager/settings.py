...
import os  # ✅ чтобы использовать os.path

# Build paths inside the project like this: BASE_DIR / 'subdir'.
BASE_DIR = Path(__file__).resolve().parent.parent

# Quick-start development settings - unsuitable for production
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-3ys3qd-iaa83v%9rs9kbr9(5ztt2m7&@6(#w9@et!rkcw(bbsx')
...
CSRF_TRUSTED_ORIGINS = [
    'https://finance-manager-hyjk.onrender.com',
]
...
# ✅ Понадобится, чтобы Render раздавал статику
